      ...
      <header style={{ background: '#fff', borderBottom: '1px solid var(--border-color)', padding: '1rem 2rem', position: 'sticky', top: 0, zIndex: 100, boxShadow: '0 2px 10px rgba(0,0,0,0.05)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ flex: 1, margin: '0 2rem', display: 'flex' }}>
            <input type="text" placeholder="Tìm kiếm bút tích, ấn phẩm..." style={{ width: '100%', padding: '0.6rem 1rem', borderRadius: '4px 0 0 4px', border: '1px solid var(--border-color)' }} />
            <button className="btn btn-primary" style={{ borderRadius: '0 4px 4px 0' }}>Search</button>
          </div>
